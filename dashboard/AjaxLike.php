...
$db = DB();
$sql = 
        // "select user_id ,account_id ,post_no , content , count ,  announce_time from(
        ...
        "select user_id ,account_id ,post_no , like_account , count ,  announce_time from(
                select user.user_id ,  userinstaaccount.account_id  , userpost.post_no  , like.like_account , count(". $type .".like_account) as count , post.announce_time FROM instabuilder.user 
                left join instabuilder.userinstaaccount on user.user_id = userinstaaccount.user_id
                left join instabuilder.userpost on userinstaaccount.account_id = userpost.account_id
                left join instabuilder.post on userpost.post_no = post.post_no
